...
::: {.center data-latex=""}
The functions of the `{invMovement}` package have already been used and results have been published (e.g. @Sander2021, @Lisovski2020JAE), I consider them in development. The theoretical concept behind the functions seems correct, however, especially the multi-core performance is not optimal and could be improved by e.g. using the future framework in R.
:::
::::
